    ...
    <main className="sectionFour">
      ...
      <section className="sectionFour__projects">
        <section className="sectionFour__projectOne">
          ...
          <p className="sectionFour__projectOne--paragraph">Gosht is a video that includes effects to make reference to
          short circuit. Also, includes background music to create a dark atmosphere and an underground voice.</p>
          <button className="sectionFour__btn" onClick={handleVideoGosht}>view video</button>
        </section>

        <section className="sectionFour__projectOne">
          <img src={flowers} alt="" className="sectionFour__projectOne--img" />
          <p className="sectionFour__projectOne--paragraph" >What do you do when your heart is broken? well even if we cannot do something perfectly I think music always
          heal what is broken inside of you.  </p>
          <button className="sectionFour__btn" onClick={handelvideoFlowers}>view video</button>
        </section>

        <section className="sectionFour__projectOne">
          <img src={dog} alt="" className="sectionFour__projectOne--img" />
          <p className="sectionFour__projectOne--paragraph">It's amazing to be in a comfortable place listening to music and doing what you love. that is the purpose of this video
          there are some background audios to recreate a calm environment.</p>
          <button className="sectionFour__btn" onClick={handleVideoDog}>view video</button>
        </section>
