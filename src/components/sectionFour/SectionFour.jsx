...
const SectionFour = () => {
  ...
  return (
    <main classnameName="sectionFour" id="SoundDesign">
      <h1 classnameName="sectionFour__title">Sound Design</h1>
      <section classnameName="sectionFour__projects">
        <section classnameName="sectionFour__projectOne">
          <img
            src={Gosht}
            alt=""
            classnameName="sectionFour__projectOne--img"
          />
          <p classnameName="sectionFour__projectOne--paragraph">
          ...
          <button classnameName="sectionFour__btn" onClick={handleVideoGosht}>
            view video
          </button>
        </section>
        ...
        <section classnameName="sectionFour__projectOne">
          ...
          <button classnameName="sectionFour__btn" onClick={handelvideoFlowers}>
            view video
          </button>
        </section>

        <section classnameName="sectionFour__projectOne">
          <img src={dog} alt="" classnameName="sectionFour__projectOne--img" />
          <p classnameName="sectionFour__projectOne--paragraph">
          ...
          <button classnameName="sectionFour__btn" onClick={handleVideoDog}>
            view video
          </button>
        </section>

        <section classnameName="sectionFour__projectOne">
          <img src={film} alt="" classnameName="sectionFour__projectOne--img" />
          <p classnameName="sectionFour__projectOne--paragraph">
          ...
          <button classnameName="sectionFour__btn" onClick={handleVideoFilm}>
            view video
          </button>
        </section>
      </section>
